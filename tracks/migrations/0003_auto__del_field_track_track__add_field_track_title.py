...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Track.track'
        db.delete_column(u'tracks_track', 'track')

        # Adding field 'Track.title'
        db.add_column(u'tracks_track', 'title',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Track.track'
        db.add_column(u'tracks_track', 'track',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)

        # Deleting field 'Track.title'
        db.delete_column(u'tracks_track', 'title')
